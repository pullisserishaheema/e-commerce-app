                ...
                <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <p className="space-x-4">
                            ...
                            {/* <button className="hover:text-white transition-colors duration-300">FAQs</button>
                            <button className="hover:text-white transition-colors duration-300">Contact Us</button> */}
                    ...
                    <div className="text-center md:text-right">
                        <h4 className="text-white text-lg font-semibold mb-2">Customer Support</h4>
                        <p className="space-x-4">
